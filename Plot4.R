...
##                  subset data, and generate Plot4.png directly via PNG device in same 
##                  directory. 
##
## Note:          Unlike Plot1 and Plot2 (but like Plot 3), the legend does not appear
##                  correctly in the PNG when attempting to perform a dev.copy() from 
##                  the screen device, and so is being generated directly. 
